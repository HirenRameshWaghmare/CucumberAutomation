...
public class MultipleScenarioStepDef {
    ...
    public void userEntersUserFirstName() throws InterruptedException {
    ...
    public void userChecksUserFirstNameIsPresent() throws InterruptedException {
    ...
    public void userEntersUserSurName() throws InterruptedException {
        //Facebook ke account creation ke form ke First Name Field ko inspect karke got the xpath value
        driver.findElement(By.xpath("//input[@id='u_1_d_bc']")).sendKeys("Waghmare");
        Thread.sleep(1000);
